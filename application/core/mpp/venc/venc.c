...
int mpp_venc_mjpeg_fps(VENC_CHN_ATTR_S *stVencChnAttr, mpp_venc_create_encoder_in *in) {
...
int mpp_venc_h264_fps(VENC_CHN_ATTR_S *stVencChnAttr, mpp_venc_create_encoder_in *in) {
    switch (in->bitrate_control) {
...
int mpp_venc_h265_fps(VENC_CHN_ATTR_S *stVencChnAttr, mpp_venc_create_encoder_in *in) {
    switch (in->bitrate_control) {
...
int mpp_venc_mjpeg_params(VENC_CHN_ATTR_S *stVencChnAttr, mpp_venc_create_encoder_in *in) {
    switch (in->bitrate_control) {
        case VENC_RC_MODE_MJPEGCBR:
            ...
            #if HI_MPP == 1
                stVencChnAttr->stRcAttr.stAttrMjpegeCbr.u32StatTime          = in->cbr.stat_time;       //mpp1: [1; 60]
                stVencChnAttr->stRcAttr.stAttrMjpegeCbr.u32FluctuateLevel    = in->cbr.fluctuate_level; //mpp1: [0; 5] (0 is recommended)
                stVencChnAttr->stRcAttr.stAttrMjpegeCbr.u32BitRate           = in->cbr.bitrate;         //mpp1: [2; 40960]
            #elif HI_MPP == 2 || \
                  HI_MPP == 3
                stVencChnAttr->stRcAttr.stAttrMjpegeCbr.u32StatTime          = in->cbr.stat_time;       //mpp2: [1; 60]                 //mpp3: [1; 60]
                stVencChnAttr->stRcAttr.stAttrMjpegeCbr.u32FluctuateLevel    = in->cbr.fluctuate_level; //mpp2: [1; 5] (1 recommended)  //mpp3: [1; 5]
                stVencChnAttr->stRcAttr.stAttrMjpegeCbr.u32BitRate           = in->cbr.bitrate;         //mpp2: [2; 102400]             //mpp3: [2; 102400]
            #elif HI_MPP == 4
                stVencChnAttr->stRcAttr.stMjpegCbr.u32StatTime               = in->cbr.stat_time;       //mpp4: [1;60]
                stVencChnAttr->stRcAttr.stMjpegCbr.u32BitRate                = in->cbr.bitrate;         //mpp4: Hi3559A V100ES/Hi3559A V100: [2, 409600] Hi3519A V100/Hi3556A V100/Hi3516C V500/Hi3516D V300: [2, 204800]
        ...
        case VENC_RC_MODE_MJPEGVBR:
            ...
            #if HI_MPP == 1
                stVencChnAttr->stRcAttr.stAttrMjpegeVbr.u32StatTime          = in->vbr.stat_time;           //mpp1: [1; 60]
                stVencChnAttr->stRcAttr.stAttrMjpegeVbr.u32MinQfactor        = in->vbr.min_q_factor;        //mpp1: [1; u32MaxQfactor)
                stVencChnAttr->stRcAttr.stAttrMjpegeVbr.u32MaxQfactor        = in->vbr.max_q_factor;        //mpp1: [1; 99]
                stVencChnAttr->stRcAttr.stAttrMjpegeVbr.u32MaxBitRate        = in->vbr.maxbitrate;             //mpp1: [2; 40960]
            #elif HI_MPP == 2 || \
                  HI_MPP == 3 
                stVencChnAttr->stRcAttr.stAttrMjpegeVbr.u32StatTime          = in->vbr.stat_time;           //mpp2: [1; 60]                 //mpp3: [1; 60]
                stVencChnAttr->stRcAttr.stAttrMjpegeVbr.u32MinQfactor        = in->vbr.min_q_factor;        //mpp2: [1; u32MaxQfactor)      //mpp3: [1; u32MaxQfactor]
                stVencChnAttr->stRcAttr.stAttrMjpegeVbr.u32MaxQfactor        = in->vbr.max_q_factor;        //mpp2: [1; 99]                 //mpp3: [1; 99]
                stVencChnAttr->stRcAttr.stAttrMjpegeVbr.u32MaxBitRate        = in->vbr.maxbitrate;             //mpp2: [2; 102400]             //mpp3: [2; 102400]
            #elif HI_MPP == 4
                stVencChnAttr->stRcAttr.stMjpegVbr.u32StatTime               = in->vbr.stat_time;           //mpp4: [1; 60] 
                stVencChnAttr->stRcAttr.stMjpegVbr.u32MaxBitRate             = in->vbr.maxbitrate;             //mpp4:
                                                                                                        //Hi3559AV100ES/Hi3559AV100：[2, 614400]
                                                                                                        //Hi3519AV100/Hi3556AV100：[2, 204800]
                                                                                                        //Hi3516CV500/Hi3516DV300/Hi3516AV300/Hi3556V200/Hi3559V200：[2, 102400]
                                                                                                        //Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200：[2,61440]
        ...
        case VENC_RC_MODE_MJPEGFIXQP:
            ...
            #if HI_MPP == 1
                stVencChnAttr->stRcAttr.stAttrMjpegeFixQp.u32Qfactor         = in->fixqp.q_factor;            //mpp1: [1; 99]
            #elif HI_MPP == 2 || \
                  HI_MPP == 3 
                stVencChnAttr->stRcAttr.stAttrMjpegeFixQp.u32Qfactor         = in->fixqp.q_factor;            //mpp2: [1; 99]                 //mpp3: [1; 99]
            #elif HI_MPP == 4
                stVencChnAttr->stRcAttr.stMjpegFixQp.u32Qfactor             = in->fixqp.q_factor;             //mpp4: [1; 99]
            #endif
            break;
        default:
            ;;;//TODO error
    ...
    switch (in->bitrate_control) {
        case VENC_RC_MODE_H264CBR:
            stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H264CBR;
                ...
                stVencChnAttr->stRcAttr.stAttrH264Cbr.u32StatTime            = in->cbr.stat_time;           //mpp1: [1; 60]
                stVencChnAttr->stRcAttr.stAttrH264Cbr.u32BitRate             = in->cbr.bitrate;             //mpp1: [2; 40960]
                stVencChnAttr->stRcAttr.stAttrH264Cbr.u32FluctuateLevel      = in->cbr.fluctuate_level;     //mpp1: [1; 5]
            #elif HI_MPP == 2 || \
                  HI_MPP == 3
                stVencChnAttr->stRcAttr.stAttrH264Cbr.u32Gop                 = in->gop;                 //mpp2: [1; 65536]              //mpp3: [1; 65536]
                stVencChnAttr->stRcAttr.stAttrH264Cbr.u32StatTime            = in->cbr.stat_time;           //mpp2: [1; 60]                 //mpp3: [1; 60]
                stVencChnAttr->stRcAttr.stAttrH264Cbr.u32BitRate             = in->cbr.bitrate;             //mpp2: [2, 102400]             //mpp3: 
                                                                                                                                        //Hi3519 V100/Hi3519 V101/Hi3531D V100/Hi3521DV100/Hi3536C V100: [2, 102400]
                                                                                                                                        //Hi3516C V300/Hi3516E V100: [2, 30720]
                stVencChnAttr->stRcAttr.stAttrH264Cbr.u32FluctuateLevel      = in->cbr.fluctuate_level;     //mpp2: [0; 5]                  //mpp3: [1; 5]
            #elif HI_MPP == 4
                stVencChnAttr->stRcAttr.stH264Cbr.u32Gop                     = in->gop;                 //mpp4: [1; 65536]
                stVencChnAttr->stRcAttr.stH264Cbr.u32StatTime                = in->cbr.stat_time;           //mpp4: [1; 60]
                stVencChnAttr->stRcAttr.stH264Cbr.u32BitRate                 = in->cbr.bitrate;             //mpp4:
                                                                                                        //Hi3559AV100ES/Hi3559AV100：[2, 614400]
                                                                                                        //Hi3519AV100/Hi3556AV100：[2, 204800]
        ...
        case VENC_RC_MODE_H264VBR:
            stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H264VBR;
                ...
                stVencChnAttr->stRcAttr.stAttrH264Vbr.u32StatTime            = in->vbr.stat_time;           //mpp1: [1; 60]
                stVencChnAttr->stRcAttr.stAttrH264Vbr.u32MinQp               = in->vbr.min_qp;              //mpp1: [0; 51]
                stVencChnAttr->stRcAttr.stAttrH264Vbr.u32MaxQp               = in->vbr.max_qp;              //mpp1: (u32MinQp; 51]
                stVencChnAttr->stRcAttr.stAttrH264Vbr.u32MaxBitRate          = in->vbr.maxbitrate;             //mpp1: [2; 40960]
            #elif HI_MPP == 2 || \
                  HI_MPP == 3
                stVencChnAttr->stRcAttr.stAttrH264Vbr.u32Gop                 = in->gop;                 //mpp2: [1; 65536]              //mpp3: [1; 65536]
                stVencChnAttr->stRcAttr.stAttrH264Vbr.u32StatTime            = in->vbr.stat_time;           //mpp2: [1; 60]                 //mpp3: [1; 60]
                stVencChnAttr->stRcAttr.stAttrH264Vbr.u32MinQp               = in->vbr.min_qp;              //mpp2: [0; 51]                 //mpp3: [0; 51]
                #if HI_MPP == 3
                    stVencChnAttr->stRcAttr.stAttrH264Vbr.u32MinIQp          = in->vbr.min_i_qp;                                            //mpp3: [u32MinQp, u32MaxQp]
                #endif
                stVencChnAttr->stRcAttr.stAttrH264Vbr.u32MaxQp               = in->vbr.max_qp;              //mpp2: (u32MinQp; 51]          //mpp3: [u32MinQp; 51]
                stVencChnAttr->stRcAttr.stAttrH264Vbr.u32MaxBitRate          = in->vbr.maxbitrate;             //mpp2: [2; 102400]             //mpp3: 
                ...
                stVencChnAttr->stRcAttr.stH264Vbr.u32StatTime                = in->vbr.stat_time;           //mpp4: [1; 60]
                stVencChnAttr->stRcAttr.stH264Vbr.u32MaxBitRate              = in->vbr.maxbitrate;             //mpp4: 
                                                                                                        //Hi3559AV100ES/Hi3559AV100：[2, 614400]
                                                                                                        //Hi3519AV100/Hi3556AV100：[2, 204800]
                                                                                                        //Hi3516CV500/Hi3516DV300/Hi3516AV300：[2,51200]
                                                                                                        //Hi3556V200/Hi3559V200：[2,102400]
        ...
        case VENC_RC_MODE_H264FIXQP:
            stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H264FIXQP;
                ...
                stVencChnAttr->stRcAttr.stAttrH264FixQp.u32IQp               = in->fixqp.i_qp;                //mpp1: [0; 51]
                stVencChnAttr->stRcAttr.stAttrH264FixQp.u32PQp               = in->fixqp.p_qp;                //mpp1: [0; 51]
          	#elif HI_MPP == 2 || \
				  HI_MPP == 3
        		stVencChnAttr->stRcAttr.stAttrH264FixQp.u32Gop               = in->gop;                 //mpp2: [1; 65536]				//mpp3: [1; 65536]
                stVencChnAttr->stRcAttr.stAttrH264FixQp.u32IQp               = in->fixqp.i_qp;                //mpp2: [0; 51]					//mpp3: [0; 51]
                stVencChnAttr->stRcAttr.stAttrH264FixQp.u32PQp               = in->fixqp.p_qp;                //mpp2: [0; 51]					//mpp3: [0; 51]
				#if HI_MPP == 3
                	stVencChnAttr->stRcAttr.stAttrH264FixQp.u32BQp           = in->fixqp.b_qp;												//mpp3: [0; 51]
				#endif
			#elif HI_MPP == 4
    			stVencChnAttr->stRcAttr.stH264FixQp.u32Gop                   = in->gop;                 //mpp4: [1; 65536]
    			stVencChnAttr->stRcAttr.stH264FixQp.u32IQp                   = in->fixqp.i_qp;                //mpp4: [0; 51]
    			stVencChnAttr->stRcAttr.stH264FixQp.u32PQp                   = in->fixqp.p_qp;                //mpp4: [0; 51]
    			stVencChnAttr->stRcAttr.stH264FixQp.u32BQp                   = in->fixqp.b_qp;                //mpp4: [0; 51]
    		#endif
            break;
		case VENC_RC_MODE_H264AVBR:
			stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H264AVBR;
                ...
                stVencChnAttr->stRcAttr.stAttrH264AVbr.u32StatTime           = in->avbr.stat_time;           //mpp2: [1; 60]					//mpp3: [1; 60]
                stVencChnAttr->stRcAttr.stAttrH264AVbr.u32MaxBitRate         = in->avbr.maxbitrate;             //mpp2: [2; 102400]				//mpp3:
																																		//Hi3519 V100/Hi3519 V101/Hi3531DV100/Hi3521D V100/Hi3536C V100: [2, 102400]
																																		//Hi3516C V300/Hi3516E V100: [2, 30720]
    		#elif HI_MPP == 4
                stVencChnAttr->stRcAttr.stH264AVbr.u32Gop                    = in->gop;                 //mpp4: [1; 65536]
                stVencChnAttr->stRcAttr.stH264AVbr.u32StatTime               = in->avbr.stat_time;           //mpp4: [1; 60]
                stVencChnAttr->stRcAttr.stH264AVbr.u32MaxBitRate             = in->avbr.maxbitrate;             //mpp4: 
                                                                                                        //Hi3559AV100ES/Hi3559AV100：[2, 614400]
                                                                                                        //Hi3519AV100/Hi3556AV100：[2, 204800]
                                                                                                        //Hi3516CV500/Hi3516DV300/Hi3516AV300：[2,51200]
                                                                                                        //Hi3556V200/Hi3559V200：[2,102400]
        ...
        case VENC_RC_MODE_H264CVBR:
			stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H264CVBR;
                ...
                stVencChnAttr->stRcAttr.stH264CVbr.u32StatTime               = in->cvbr.stat_time;           //mpp4: [1, 60]
                stVencChnAttr->stRcAttr.stH264CVbr.u32LongTermStatTime       = in->cvbr.long_stat_time;                       //mpp4: [1, 1440]
                stVencChnAttr->stRcAttr.stH264CVbr.u32ShortTermStatTime      = in->cvbr.short_stat_time;                       //mpp4: [1; 120]
                stVencChnAttr->stRcAttr.stH264CVbr.u32MaxBitRate             = in->cvbr.maxbitrate;             //mpp4: 
                                                                                                        //Hi3559AV100ES/Hi3559AV100：[2, 614400]
                                                                                                        //Hi3519AV100/Hi3556AV100：[2, 204800]
                                                                                                        //Hi3516CV500/Hi3516DV300/Hi3516AV300：[2,51200]
                                                                                                        //Hi3556V200/Hi3559V200：[2,102400]
                                                                                                        //Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200：[2,61440]
                stVencChnAttr->stRcAttr.stH264CVbr.u32LongTermMaxBitrate     = in->cvbr.long_maxbitrate;             //mpp4: [2; u32MaxBitRate]  //1024 + 512*u32FrameRate/30; //TODO
                stVencChnAttr->stRcAttr.stH264CVbr.u32LongTermMinBitrate     = in->cvbr.long_minbitrate;                     //mpp4: [0; u32LongTermMaxBitrate]
         	#endif
			break;
		case VENC_RC_MODE_H264QVBR:
            stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H264QVBR;
                ...
                stVencChnAttr->stRcAttr.stAttrH264QVbr.u32StatTime           = in->qvbr.stat_time;           //mpp3: [1; 60]
                stVencChnAttr->stRcAttr.stAttrH264QVbr.u32TargetBitRate      = in->qvbr.bitrate;             //mpp3: 
                                                                                                        //Hi3519 V100/Hi3519 V101/Hi3531DV100/Hi3521D V100/Hi3536C V100: [2, 102400]
                                                                                                        //Hi3516C V300/Hi3516E V100: [2, 30720]
          	#elif HI_MPP == 4
            	stVencChnAttr->stRcAttr.stH264QVbr.u32Gop                    = in->gop;                 //mpp4: [1; 65536]
                stVencChnAttr->stRcAttr.stH264QVbr.u32StatTime               = in->qvbr.stat_time;           //mpp4: [1; 60]
                stVencChnAttr->stRcAttr.stH264QVbr.u32TargetBitRate          = in->qvbr.bitrate;             //mpp4: 
                                                                                                        //Hi3559AV100ES/Hi3559AV100：[2, 614400]
                                                                                                        //Hi3519AV100/Hi3556AV100：[2, 204800]
                                                                                                        //Hi3516CV500/Hi3516DV300/Hi3516AV300：[2,51200]
                                                                                                        //Hi3556V200/Hi3559V200：[2,102400]
    ...
    switch (in->bitrate_control) {
		case VENC_RC_MODE_H265CBR:																		
			stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H265CBR;
                ...
                stVencChnAttr->stRcAttr.stAttrH265Cbr.u32StatTime            = in->cbr.stat_time;           //mpp2: [1; 60]                     //mpp3: [1; 60]
                stVencChnAttr->stRcAttr.stAttrH265Cbr.u32BitRate             = in->cbr.bitrate;             //mpp2: [2; 102400]                 //mpp3:
                                                                                                                                            //Hi3519 V100/Hi3519 V101/Hi3531DV100/Hi3521D V100/Hi3536C V100: [2, 102400]
                                                                                                                                            //Hi3516C V300/Hi3516E V100: [2, 30720]
                stVencChnAttr->stRcAttr.stAttrH265Cbr.u32FluctuateLevel      = in->cbr.fluctuate_level;   	//mpp2: [0, 5] (0 is recommended)???//mpp3: [1, 5] (1 is recommended)
			#elif HI_MPP == 4
                stVencChnAttr->stRcAttr.stH265Cbr.u32Gop                     = in->gop;                 //mpp4: [1; 65536]
                stVencChnAttr->stRcAttr.stH265Cbr.u32StatTime                = in->cbr.stat_time;           //mpp4: [1; 60]
                stVencChnAttr->stRcAttr.stH265Cbr.u32BitRate                 = in->cbr.bitrate;             //mpp4:
                                                                                                        //Hi3559AV100ES/Hi3559AV100：[2, 614400]
                                                                                                        //Hi3519AV100/Hi3556AV100：[2, 204800]
                                                                                                        //Hi3516CV500/Hi3516DV300/Hi3516AV300：[2,51200]
                                                                                                        //Hi3556V200/Hi3559V200：[2,102400]
		...
		case VENC_RC_MODE_H265VBR:
			stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H265VBR;
                ...
                stVencChnAttr->stRcAttr.stAttrH265Vbr.u32StatTime            = in->vbr.stat_time;           //mpp2: [1; 60]                     //mpp3: [1; 60]
                stVencChnAttr->stRcAttr.stAttrH265Vbr.u32MinQp               = in->vbr.min_qp;              //mpp2: [0; 51]                     //mpp3: [0; 51]
				#if HI_MPP == 3
                    stVencChnAttr->stRcAttr.stAttrH265Vbr.u32MinIQp          = in->vbr.min_i_qp;                                                //mpp3: [u32MinQp; u32MaxQp]
				#endif
                stVencChnAttr->stRcAttr.stAttrH265Vbr.u32MaxQp               = in->vbr.max_qp;              //mpp2: (u32MinQp; 51]              //mpp3: [u32MinQp; 51]
        		stVencChnAttr->stRcAttr.stAttrH265Vbr.u32MaxBitRate          = in->vbr.maxbitrate;             //mpp2: [2; 102400]                 //mpp3:
                                                                                                                                            //Hi3519 V100/Hi3519 V101/Hi3531DV100/Hi3521D V100/Hi3536C V100: [2, 102400]
                                                                                                                                            //Hi3516C V300/Hi3516E V100: [2, 30720]
    		#elif HI_MPP == 4 
            	stVencChnAttr->stRcAttr.stH265Vbr.u32Gop                     = in->gop;                 //mpp4: [1; 65536]
                stVencChnAttr->stRcAttr.stH265Vbr.u32StatTime                = in->vbr.stat_time;           //mpp4: [1; 60]
                stVencChnAttr->stRcAttr.stH265Vbr.u32MaxBitRate              = in->vbr.maxbitrate;             //mpp4:
                                                                                                        //Hi3559AV100ES/Hi3559AV100：[2, 614400]
                                                                                                        //Hi3519AV100/Hi3556AV100：[2, 204800]
                                                                                                        //Hi3516CV500/Hi3516DV300/Hi3516AV300：[2,51200]
                                                                                                        //Hi3556V200/Hi3559V200：[2,102400]
		...
		case VENC_RC_MODE_H265FIXQP:
            stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H265FIXQP;
                ...
                stVencChnAttr->stRcAttr.stAttrH265FixQp.u32IQp               = in->fixqp.i_qp;                //mpp2: [0; 51]                     //mpp3: [0; 51]
                stVencChnAttr->stRcAttr.stAttrH265FixQp.u32PQp               = in->fixqp.p_qp;                //mpp2: [0; 51]                     //mpp3: [0; 51]
				#if HI_MPP == 3
					stVencChnAttr->stRcAttr.stAttrH265FixQp.u32BQp           = in->fixqp.b_qp;                                                    //mpp3: [0; 51]
				#endif
			#elif HI_MPP == 4
            	stVencChnAttr->stRcAttr.stH265FixQp.u32Gop                   = in->gop;                 //mpp4: [1; 65536]
                stVencChnAttr->stRcAttr.stH265FixQp.u32IQp                   = in->fixqp.i_qp;                //mpp4: [0; 51]
                stVencChnAttr->stRcAttr.stH265FixQp.u32PQp                   = in->fixqp.p_qp;                //mpp4: [0; 51]
                stVencChnAttr->stRcAttr.stH265FixQp.u32BQp                   = in->fixqp.b_qp;                //mpp4: [0; 51]
           	#endif
		case VENC_RC_MODE_H265AVBR:
            stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H265AVBR;
        		...
        		stVencChnAttr->stRcAttr.stH265AVbr.u32StatTime               = in->avbr.stat_time;           //mpp4: [1; 60]
                stVencChnAttr->stRcAttr.stH265AVbr.u32MaxBitRate             = in->avbr.maxbitrate;             //mpp4:
                                                                                                        //Hi3559AV100ES/Hi3559AV100：[2, 614400]
                                                                                                        //Hi3519AV100/Hi3556AV100：[2, 204800]
                                                                                                        //Hi3516CV500/Hi3516DV300/Hi3516AV300：[2,51200]
                                                                                                        //Hi3556V200/Hi3559V200：[2,102400]
        ...
        case VENC_RC_MODE_H265CVBR:
            stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H265CVBR;
                ...
                stVencChnAttr->stRcAttr.stH265CVbr.u32StatTime               = in->cvbr.stat_time;           //mpp4: [1; 60]
                stVencChnAttr->stRcAttr.stH265CVbr.u32LongTermStatTime       = in->cvbr.long_stat_time;                       //mpp4: [1; 1440]
                stVencChnAttr->stRcAttr.stH265CVbr.u32ShortTermStatTime      = in->cvbr.short_stat_time;                       //mpp4: [1; 120]
                stVencChnAttr->stRcAttr.stH265CVbr.u32MaxBitRate             = in->cvbr.maxbitrate;             //mpp4: 
                                                                                                        //Hi3559AV100ES/Hi3559AV100：[2, 614400]
                                                                                                        //Hi3519AV100/Hi3556AV100：[2, 204800]
                                                                                                        //Hi3516CV500/Hi3516DV300/Hi3516AV300：[2,51200]
                                                                                                        //Hi3556V200/Hi3559V200：[2,102400]
                                                                                                        //Hi3516EV200/Hi3516EV300/Hi3518EV300/Hi3516DV200：[2,61440]。
                stVencChnAttr->stRcAttr.stH265CVbr.u32LongTermMaxBitrate     = in->cvbr.long_maxbitrate;             //mpp4: [2; u32MaxBitRate]          //1024 + 512*u32FrameRate/30; //TODO
                stVencChnAttr->stRcAttr.stH265CVbr.u32LongTermMinBitrate     = in->cvbr.long_minbitrate;                     //mpp4: [0; u32LongTermMaxBitrate]
            #endif
            break;
        case VENC_RC_MODE_H265QVBR:
            stVencChnAttr->stRcAttr.enRcMode = VENC_RC_MODE_H265QVBR;
                ...
                stVencChnAttr->stRcAttr.stAttrH265QVbr.u32StatTime           = in->qvbr.stat_time;           //mpp3: [1; 60]
                stVencChnAttr->stRcAttr.stAttrH265QVbr.u32TargetBitRate      = in->qvbr.bitrate;             //mpp3: 
                                                                                                        //Hi3519 V100/Hi3519 V101/Hi3531DV100/Hi3521D V100/Hi3536C V100: [2, 102400]
                                                                                                        //Hi3516C V300/Hi3516E V100: [2, 30720]
            #elif HI_MPP == 4
                stVencChnAttr->stRcAttr.stH265QVbr.u32Gop                    = in->gop;                 //mpp4: [1; 65536]
                stVencChnAttr->stRcAttr.stH265QVbr.u32StatTime               = in->qvbr.stat_time;           //mpp4: [1; 60]
                stVencChnAttr->stRcAttr.stH265QVbr.u32TargetBitRate          = in->qvbr.bitrate;             //mpp4:
                                                                                                        //Hi3559AV100ES/Hi3559AV100：[2, 614400]
                                                                                                        //Hi3519AV100/Hi3556AV100：[2, 204800]
                                                                                                        //Hi3516CV500/Hi3516DV300/Hi3516AV300：[2,51200]
                                                                                                        //Hi3556V200/Hi3559V200：[2,102400]
...
int mpp_venc_create_encoder(error_in *err, mpp_venc_create_encoder_in *in) {
    ...
    switch (in->codec) {
        case PT_MJPEG:
            mpp_venc_mjpeg_fps(&stVencChnAttr, in);
            mpp_venc_mjpeg_params(&stVencChnAttr, in);
            break;
        case PT_H264:
            mpp_venc_h264_fps(&stVencChnAttr, in);
            mpp_venc_h264_params(&stVencChnAttr, in);
            break;
        case PT_H265:
            mpp_venc_h265_fps(&stVencChnAttr, in);
    ...
    switch (in->gop_mode) {
        case VENC_GOPMODE_NORMALP:
            ...
            stVencChnAttr.stGopAttr.stNormalP.s32IPQpDelta      = in->normalp.i_pq_delta;           //mpp3: [-10; 30]                                                               //mpp4: [-10; 30]
            break;
        case VENC_GOPMODE_DUALP:
			stVencChnAttr.stGopAttr.enGopMode  					= VENC_GOPMODE_DUALP;
            stVencChnAttr.stGopAttr.stDualP.u32SPInterval		= in->dualp.s_p_interval;         //mpp3: [0, 1)U(1, u32Gop – 1] (u32Gop indicates the interval of the I-frames)  //mpp4: 
            stVencChnAttr.stGopAttr.stDualP.s32SPQpDelta		= in->dualp.s_pq_delta;           //mpp3: [-10; 30]                                                               //mpp4: [-10; 30]
            stVencChnAttr.stGopAttr.stDualP.s32IPQpDelta		= in->dualp.i_pq_delta;           //mpp3: [-10; 30]                                                               //mpp4: [-10; 30]
            break;
        case VENC_GOPMODE_SMARTP:
			stVencChnAttr.stGopAttr.enGopMode 					= VENC_GOPMODE_SMARTP;
			stVencChnAttr.stGopAttr.stSmartP.u32BgInterval		= in->smartp.bg_interval;          //mpp3: u32BgInterval must be greater than or equal to                          //mpp4: [u32Gop, 65536]
                                                                                            //u32Gop and must be an integral multiple of u32Gop.
            stVencChnAttr.stGopAttr.stSmartP.s32BgQpDelta		= in->smartp.bg_qp_delta;          //mpp3: [-10; 30]                                                               //mpp4: [-10; 30]
            stVencChnAttr.stGopAttr.stSmartP.s32ViQpDelta		= in->smartp.vi_qp_delta;          //mpp3: [-10; 30]                                                               //mpp4: [-10; 30]
            break;
        case VENC_GOPMODE_ADVSMARTP: //TODO should be turned on by API call configured to ordinary smartp
            #if HI_MPP == 3
                ;;; //TODO error
            #elif HI_MPP == 4
			stVencChnAttr.stGopAttr.enGopMode 					= VENC_GOPMODE_ADVSMARTP;
            stVencChnAttr.stGopAttr.stAdvSmartP.u32BgInterval	= in->advsmartp.bg_interval;          //mpp4: [u32Gop; 65536]                                                         
            stVencChnAttr.stGopAttr.stAdvSmartP.s32BgQpDelta	= in->advsmartp.bg_qp_delta;          //mpp4: [-10; 30]                                                               
            stVencChnAttr.stGopAttr.stAdvSmartP.s32ViQpDelta	= in->advsmartp.vi_qp_delta;          //mpp4: [-10; 30]                                                               
            #endif
            break;
        case VENC_GOPMODE_BIPREDB:
			//TODO hi3516cv300 doesn`t support it
			stVencChnAttr.stGopAttr.enGopMode 					= VENC_GOPMODE_BIPREDB;
            stVencChnAttr.stGopAttr.stBipredB.u32BFrmNum		= in->bipredb.b_frm_num;            //mpp3: [1; 3]	                                                                //mpp4: [1; 3]
            stVencChnAttr.stGopAttr.stBipredB.s32BQpDelta		= in->bipredb.b_qp_delta;           //mpp3: [-10; 30]                                                               //mpp4: [-10; 30]
            stVencChnAttr.stGopAttr.stBipredB.s32IPQpDelta		= in->bipredb.i_pq_delta;           //mpp3: [-10; 30]                                                               //mpp4: [-10; 30]
            break;
        case VENC_GOPMODE_INTRAREFRESH:
            stVencChnAttr.stGopAttr.enGopMode                   = VENC_GOPMODE_NORMALP;
            stVencChnAttr.stGopAttr.stNormalP.s32IPQpDelta      = -1;//in->intrar.i_pq_delta;           //mpp3: [-10; 30]                                                               //mpp4: [-10; 30]
        default:
            ;;;//TODO error
    }
...
int mpp_venc_scene(error_in *err, int id, int scene) {
    ...
    enSceneMode = scene;
    DO_OR_RETURN_ERR_MPP(err, HI_MPI_VENC_SetSceneMode, id, enSceneMode);
...
int mpp_venc_update_fps2(error_in *err, int id, int in, int out) {
    ...
    DO_OR_RETURN_ERR_MPP(err, HI_MPI_VENC_GetFrameRate, id, &stFrameRate);
    printf("s32SrcFrmRate %d, s32DstFrmRate %d\n", stFrameRate.s32SrcFrmRate, stFrameRate.s32DstFrmRate);

    stFrameRate.s32SrcFrmRate = in;
    stFrameRate.s32DstFrmRate = out;

    DO_OR_RETURN_ERR_MPP(err, HI_MPI_VENC_SetFrameRate, id, &stFrameRate);
...
int mpp_venc_update_fps(error_in *err, mpp_venc_create_encoder_in *in) {
    ...
    DO_OR_RETURN_ERR_MPP(err, HI_MPI_VENC_GetChnAttr, in->id, &stVencChnAttr);
    ...
    DO_OR_RETURN_ERR_MPP(err, HI_MPI_VENC_SetChnAttr, in->id, &stVencChnAttr);

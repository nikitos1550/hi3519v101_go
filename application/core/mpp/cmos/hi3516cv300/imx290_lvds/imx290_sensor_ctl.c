...
const unsigned char imx290_lvds_i2c_addr     =    0x34;        /* I2C Address of IMX290 */
const unsigned int  imx290_lvds_addr_byte    =    2;
const unsigned int  imx290_lvds_data_byte    =    1;
static int g_fd = -1;

//extern WDR_MODE_E genSensorMode_imx290_lvds;
extern HI_U8 gu8SensorImageMode_imx290_lvds;
extern HI_BOOL bSensorInit_imx290_lvds;
...
int imx290_lvds_i2c_init(void)
{
    ...
    ret = ioctl(g_fd, I2C_SLAVE_FORCE, (imx290_lvds_i2c_addr>>1));
    if (ret < 0)
    {
...
int imx290_lvds_read_register(int addr)
{
    // TODO: 
...
int imx290_lvds_write_register(int addr, int data)
{
#ifdef HI_GPIO_I2C
    i2c_data.dev_addr = imx290_lvds_i2c_addr;
    i2c_data.reg_addr = addr;
    i2c_data.addr_byte_num = imx290_lvds_addr_byte;
    i2c_data.data = data;
    i2c_data.data_byte_num = imx290_lvds_data_byte;
    ...
    ret = write(g_fd, buf, (imx290_lvds_addr_byte + imx290_lvds_data_byte));
    if(ret < 0)
    {
...
void imx290_lvds_prog(int* rom)
{
    ...
    while (1) {
        ...
        if (addr == 0xFFFE) {
            ...
            imx290_lvds_write_register(addr, data);
        }
    }
}
...
static void imx290_lvds_linear_1080p30_init(HI_VOID);

//void sensor_init(HI_VOID)
void imx290_lvds_init(HI_VOID)
{
    imx290_lvds_i2c_init();
    
    /* When sensor first init, config all registers */
    if (HI_FALSE == bSensorInit_imx290_lvds) 
    {
        ...
        //else
        //{
            imx290_lvds_linear_1080p30_init();
            bSensorInit_imx290_lvds = HI_TRUE;
        //}
    }
...
void imx290_lvds_exit(HI_VOID)
{
    imx290_lvds_i2c_exit();//sensor_i2c_exit();

    return;
}

void imx290_lvds_linear_1080p30_init(HI_VOID) {
    imx290_lvds_write_register (0x3000, 0x01); /* standby */
    imx290_lvds_write_register (0x3002, 0x01); /* XTMSTA */
   
    imx290_lvds_write_register (0x3005, 0x01); //ADBIT

    imx290_lvds_write_register (0x3046, 0xe1); //配置为LVDS(根据sensor板的OMODEpin的高低情况定，我的是Fixed to High)
   
    imx290_lvds_write_register (0x3129, 0x00); //ADBIT1
    imx290_lvds_write_register (0x317c, 0x00); //ADBIT2
    imx290_lvds_write_register (0x31ec, 0x0e); //ADBIT3
    imx290_lvds_write_register (0x3441, 0x0c); //CSI_DT_FMT
    imx290_lvds_write_register (0x3442, 0x0c); //CSI_DT_FMT
  
    imx290_lvds_write_register (0x3007, 0x00);  
    imx290_lvds_write_register (0x300c, 0x00);
    imx290_lvds_write_register (0x300f, 0x00);
    imx290_lvds_write_register (0x3010, 0x21);
    imx290_lvds_write_register (0x3012, 0x64);
    imx290_lvds_write_register (0x3016, 0x09);
    imx290_lvds_write_register (0x3017, 0x00);
   
    imx290_lvds_write_register (0x3020, 0x02);
    imx290_lvds_write_register (0x305c, 0x18);
    imx290_lvds_write_register (0x305d, 0x03);
    imx290_lvds_write_register (0x305e, 0x20);
    imx290_lvds_write_register (0x305f, 0x01);
    imx290_lvds_write_register (0x3070, 0x02);
    imx290_lvds_write_register (0x3071, 0x11);
    imx290_lvds_write_register (0x309b, 0x10);
    imx290_lvds_write_register (0x309c, 0x22);
    imx290_lvds_write_register (0x30a2, 0x02);
    imx290_lvds_write_register (0x30a6, 0x20);
    imx290_lvds_write_register (0x30a8, 0x20);
    imx290_lvds_write_register (0x30aa, 0x20);
    imx290_lvds_write_register (0x30ac, 0x20);
   
    imx290_lvds_write_register (0x30b0, 0x43);
    imx290_lvds_write_register (0x3119, 0x9e);
    imx290_lvds_write_register (0x311c, 0x1e);
    imx290_lvds_write_register (0x311e, 0x08);
    imx290_lvds_write_register (0x3128, 0x05);
    imx290_lvds_write_register (0x313d, 0x83);
    imx290_lvds_write_register (0x3150, 0x03);

    imx290_lvds_write_register (0x317e, 0x00);
    imx290_lvds_write_register (0x315e, 0x1a);//INCK = 37.125 MHz : 1Ah
    imx290_lvds_write_register (0x3164, 0x1a);
    imx290_lvds_write_register (0x32b8, 0x50);

    imx290_lvds_write_register (0x32b9, 0x10);
    imx290_lvds_write_register (0x32ba, 0x00);
    imx290_lvds_write_register (0x32bb, 0x04);
    imx290_lvds_write_register (0x32c8, 0x50);
    imx290_lvds_write_register (0x32c9, 0x10);
    imx290_lvds_write_register (0x32ca, 0x00);
    imx290_lvds_write_register (0x32cb, 0x04);
    imx290_lvds_write_register (0x332c, 0xd3);
    imx290_lvds_write_register (0x332d, 0x10);
    imx290_lvds_write_register (0x332e, 0x0d);
    imx290_lvds_write_register (0x3358, 0x06);
    imx290_lvds_write_register (0x3359, 0xe1);
    imx290_lvds_write_register (0x335a, 0x11);
    imx290_lvds_write_register (0x3360, 0x1e);
   
    imx290_lvds_write_register (0x3361, 0x61);
    imx290_lvds_write_register (0x3362, 0x10);
    imx290_lvds_write_register (0x33b0, 0x50);
    imx290_lvds_write_register (0x33b2, 0x1a);
    imx290_lvds_write_register (0x33b3, 0x04);
    imx290_lvds_write_register (0x3414, 0x0a);
    imx290_lvds_write_register (0x3418, 0x49);
    imx290_lvds_write_register (0x3419, 0x04);
    imx290_lvds_write_register (0x3444, 0x20);
    imx290_lvds_write_register (0x3445, 0x25);

    imx290_lvds_write_register (0x3446, 0x47);
    imx290_lvds_write_register (0x3447, 0x0);
    imx290_lvds_write_register (0x3448, 0x1f);
    imx290_lvds_write_register (0x3449, 0x0);
    imx290_lvds_write_register (0x344a, 0x17);
    imx290_lvds_write_register (0x344b, 0x0);
    imx290_lvds_write_register (0x344c, 0x0f);
    imx290_lvds_write_register (0x344d, 0x0);
    imx290_lvds_write_register (0x344e, 0x17);
    imx290_lvds_write_register (0x344f, 0x0);
    imx290_lvds_write_register (0x3450, 0x47);
    imx290_lvds_write_register (0x3451, 0x0);
    imx290_lvds_write_register (0x3452, 0x0f);
    imx290_lvds_write_register (0x3453, 0x0);
    imx290_lvds_write_register (0x3454, 0x0f);
    imx290_lvds_write_register (0x3455, 0x0);

    imx290_lvds_write_register (0x3480, 0x49);

    imx290_lvds_write_register (0x3000, 0x00); /* standby */
    delay_ms(20);
    imx290_lvds_write_register (0x3002, 0x00); /* master mode start */
    imx290_lvds_write_register (0x304b, 0x0a); /* XVSOUTSEL XHSOUTSEL */

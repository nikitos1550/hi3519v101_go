    ...
    switch (type) {
      ...
      case 'section':
        ...
        return (
          <>
            {content && (
            <Section id={item.id} underlined={item.type === 'operation'} style={{paddingTop:"0px", paddingBottom:"0px"}}>
                {content}
            </Section>
            )}
...
export class SectionItem extends React.Component<ContentItemProps> {
  render() {
    ...
    return (
      <>
        <Row>
          <MiddlePanel compact={false} style={{paddingTop:"0px", paddingBottom:"0px"}}>
            <Header>

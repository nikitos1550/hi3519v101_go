...
func init() {
    openapi.AddRoute("debugExpvarHtml", "/debug/vars.html", "GET", debugExpvarHtml)
}
...
func debugExpvarHtml(w http.ResponseWriter, r *http.Request) {
    log.Println("debugExpvarHtml")

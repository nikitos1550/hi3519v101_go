...
//go:generate go run -tags "generate hi3516ev200" ./generate.go --output kobin_hi3516ev200.go --tag hi3516ev200 --dir ../../sdk/hi3516ev200/ko/ --pkg ko --source ./hi3516ev200.go
...
var (
        ModulesList = [...][2]string{
                [2]string{"sys_config.ko", "chip={chipName} sensors=NULL  g_cmos_yuv_flag=0 board="}, //TODO!!!!!!!!!!!!!!!!

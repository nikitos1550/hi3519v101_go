...
//go:generate go run -tags "generate hi3516cv300" ./generate.go --output kobin_hi3516cv300.go --tag hi3516cv300 --dir ../../sdk/hi3516cv300/ko/ --pkg ko --source ./hi3516cv300.go

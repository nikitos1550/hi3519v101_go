...
var (
	ModulesList = [...][2]string{
		...
		[2]string{"hi3516cv300_sys.ko", "vi_vpss_online=0 sensor={cmos} mem_total={mem_total_size}"},
		[2]string{"hi3516cv300_region.ko", ""},
		[2]string{"hi3516cv300_vgs.ko", "vgs_clk_frequency=297000000"},
		...
		[2]string{"hi3516cv300_vpss.ko", "vpss_clk_frequency=250000000"},
		...
		[2]string{"hi3516cv300_vedu.ko", "vedu_clk_frequency=198000000"},
		[2]string{"hi3516cv300_h264e.ko", ""},
		[2]string{"hi3516cv300_h265e.ko", ""},
		[2]string{"hi3516cv300_jpege.ko", ""},
		[2]string{"hi3516cv300_ive.ko", "save_power=1 ive_clk_frequency=297000000"},

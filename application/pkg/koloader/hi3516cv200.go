...
//go:generate go run -tags "generate hi3516cv200" ./generate.go --output hi3516cv200_kobin.go --tag hi3516cv200 --dir ../../sdk/hi3516cv200/ko --pkg koloader --source ./hi3516cv200.go

...
var (
	codes = map[uint]codeInfo{
		...
		0xA0338003: codeInfo{name: "HI_ERR_FISHEYE_ILLEGAL_PARAM", desc: "The configuration of fisheye parameters is invalid"},
		...
		0xA0338009: codeInfo{name: "HI_ERR_FISHEYE_NOT_PERMITTED", desc: "This operation is not allowed"},
		//IVE

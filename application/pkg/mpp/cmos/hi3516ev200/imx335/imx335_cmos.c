...
#define IMX335_RES_IS_4M_10BIT_WDR(w, h)    ((w <= 2560) && (h <= 1440))
...
static HI_S32 cmos_get_ae_default(VI_PIPE ViPipe, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    {
        pstAeSnsDft->u32LinesPer500ms = pstAeSnsDft->u32LinesPer500ms;
    }
...
static HI_VOID cmos_fps_set(VI_PIPE ViPipe, HI_FLOAT f32Fps, AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    if (f32Fps > u32MaxFps || u32Lines > IMX335_FULL_LINES_MAX)
    {
        ISP_TRACE(HI_DBG_ERR, "Not support Fps: %f\n", f32Fps);
        return;
    }
                                       ...
                                       AE_SENSOR_DEFAULT_S *pstAeSnsDft)
{
    ...
    {
        pstSnsState->astRegsInfo[0].astI2cData[8].u32Data = IMX335_LOW_8BITS(pstSnsState->au32FL[0]);    //VMAX
        pstSnsState->astRegsInfo[0].astI2cData[9].u32Data = IMX335_MID_8BITS(pstSnsState->au32FL[0]);
        pstSnsState->astRegsInfo[0].astI2cData[10].u32Data = IMX335_HIG_4BITS(pstSnsState->au32FL[0]);
    }

    pstAeSnsDft->u32FullLines = pstSnsState->au32FL[0];
    pstAeSnsDft->u32MaxIntTime = pstSnsState->au32FL[0] - 18;
...
static HI_VOID cmos_inttime_update(VI_PIPE ViPipe, HI_U32 u32IntTime)
{
    ...
    static HI_U32 u32RHS1 = 0;
    static HI_U32 u32SHR0 = 8872;
    static HI_U32 u32SHR1 = 0;
    HI_U32 u32delta = 0;
    HI_U32 u32Value = 0;
    ...
    if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode)
    {
        ...
        else/* long exposure */
        {
            ...
            u32RHS1 = u32SHR1 + u32ShortIntTime -  (u32ShortIntTime % 8) + 8;

            if (u32SHR0 < u32RHS1 + 18)
            {
                u32SHR0 = u32RHS1 + 18;
            }
            else
    ...
    else  //Linear
    {
        ...
        u32Value = pstSnsState->au32FL[0] - LinearExpTime;
...
static HI_VOID cmos_get_inttime_max(VI_PIPE ViPipe, HI_U16 u16ManRatioEnable, HI_U32 *au32Ratio, HI_U32 *au32IntTimeMax, HI_U32 *au32IntTimeMin, HI_U32 *pu32LFMaxIntTime)
{
    ...
    HI_U32 u32ShortTimeMinLimit = 27;
    HI_U32 u32delta;
    static HI_U32 u32LastIntTimeMaxTmp = 27;
    //printf("Ratio = %d\n", au32Ratio[0]);
...
static HI_S32 cmos_set_image_mode(VI_PIPE ViPipe, ISP_CMOS_SENSOR_IMAGE_MODE_S *pstSensorImageMode)
{
    ...
    if (WDR_MODE_2To1_LINE == pstSnsState->enWDRMode)
    {
        if (IMX335_RES_IS_4M_10BIT_WDR(pstSensorImageMode->u16Width, pstSensorImageMode->u16Height))
        {

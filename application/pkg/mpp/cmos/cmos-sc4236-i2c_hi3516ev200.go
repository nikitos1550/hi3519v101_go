...
//+build arm
//+build hi3516ev200
//+build sc4236,cmos_data_mipi,cmos_control_i2c,cmos_bus_0
...
combo_dev_attr_t MIPI_2lane_SENSOR_SC4236_10BIT_3M_NOWDR_ATTR =
{
    .devno = 0,
    ...
    cmosItem = cmos{   
        ...
        modes: []cmosMode {
            cmosMode {
                ...
                height: 1296,
                fps: 30,
                mipi: unsafe.Pointer(&C.MIPI_2lane_SENSOR_SC4236_10BIT_3M_NOWDR_ATTR),
                viDev: unsafe.Pointer(&C.DEV_ATTR_SC4236_3M_BASE),
                clock: 0,
                wdr: WDRNone,
                description: "normal",
            },

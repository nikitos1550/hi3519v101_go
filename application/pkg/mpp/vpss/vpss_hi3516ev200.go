...
int mpp4_vpss_sample_channel0(unsigned int *error_code) {
    *error_code = 0;
    return ERR_NONE;
}
*/
...
func SampleChannel0() {
	...
	switch err := C.mpp4_vpss_sample_channel0(&errorCode); err {
	case C.ERR_NONE:
		log.Println("C.mpp4_vpss_sample_channel0() ok")
	case C.ERR_MPP:
		log.Fatal("C.mpp4_vpss_sample_channel0() MPP error ", error.Resolve(int64(errorCode)))
	default:
		log.Fatal("Unexpected return ", err, " of C.mpp4_vpss_sample_channel0()")
	}

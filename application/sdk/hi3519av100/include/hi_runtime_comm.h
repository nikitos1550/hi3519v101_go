...
/*runtime group info after LoadModelGroup*/
typedef struct hiRUNTIME_GROUP_HANDLE_S
{
    HI_VOID *pHiRTInternal;
} HI_RUNTIME_GROUP_HANDLE_S;
...
none.
*/
typedef HI_S32 (*HI_RUNTIME_Forward_Callback)(HI_RUNTIME_FORWARD_STATUS_CALLBACK_E enEvent, HI_RUNTIME_GROUP_HANDLE_S* pstGroup, HI_U64 u64SrcId, HI_RUNTIME_GROUP_DST_BLOB_ARRAY_PTR pstDst);

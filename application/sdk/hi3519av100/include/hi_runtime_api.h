...
*   Parameters   : HI_RUNTIME_GROUP_HANDLE_S*            pstGroup    Group Handle generated by HI_SVPRT_RUNTIME_LoadModelGroup
*                  HI_RUNTIME_GROUP_SRC_BLOB_ARRAY_PTR   pstSrc      Input Blobs 
*                  HI_RUNTIME_GROUP_DST_BLOB_ARRAY_PTR   pstDst      Output Blobs.
*   Return Value: HI_SUCCESS: Success; Error codes: Failure.
*****************************************************************************/
HI_S32 HI_SVPRT_RUNTIME_ForwardGroupSync(IN const HI_RUNTIME_GROUP_HANDLE_S* pstGroup, IN const HI_RUNTIME_GROUP_SRC_BLOB_ARRAY_PTR pstSrc, OUT HI_RUNTIME_GROUP_DST_BLOB_ARRAY_PTR pstDst, IN HI_U64 u64SrcId);
...
*   Return Value: HI_SUCCESS: Success; Error codes: Failure.
*****************************************************************************/
HI_S32 HI_SVPRT_RUNTIME_ForwardGroupASync(IN const HI_RUNTIME_GROUP_HANDLE_S* pstGroup, IN const HI_RUNTIME_GROUP_SRC_BLOB_ARRAY_PTR pstSrc, OUT HI_RUNTIME_GROUP_DST_BLOB_ARRAY_PTR pstDst, IN HI_U64 u64SrcId, IN HI_RUNTIME_Forward_Callback pCbFun);
...
*   Return Value : HI_SUCCESS: Success; Error codes: Failure.
*****************************************************************************/
HI_S32 HI_SVPRT_RUNTIME_UnloadModelGroup(IN const HI_RUNTIME_GROUP_HANDLE_S* pstGroup);

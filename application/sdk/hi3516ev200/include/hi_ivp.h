...
*   Parameters   : hi_ivp_mem_info *ivp_file_mem_info:Input
...
*
*****************************************************************************/
hi_s32 hi_ivp_load_resource_from_memory(hi_ivp_mem_info *ivp_file_mem_info,hi_s32 *ivp_handle);
...
*   Parameters   : hi_s32 ivp_handle:Input
                   hi_ivp_ctrl_attr *ivp_ctrl_attr:input
*                  
*   Return Value : HI_SUCCESS: Success;Error codes: Failure.
*   Spec         : 
*   History:
...
*
*****************************************************************************/
hi_s32 hi_ivp_set_ctrl_attr(hi_s32 ivp_handle, hi_ivp_ctrl_attr *ivp_ctrl_attr);
...
*   Description  : Process.
*   Parameters   : hi_s32 ivp_handle:Input
                   VIDEO_FRAME_INFO_S *src_frame:Input
...
*
*****************************************************************************/
hi_s32 hi_ivp_process(hi_s32 ivp_handle,VIDEO_FRAME_INFO_S *src_frame,hi_bool *obj_alarm);

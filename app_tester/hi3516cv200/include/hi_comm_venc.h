...
typedef struct hiVENC_PARAM_H265_ASPECT_RATIO_S
{
    HI_U32 aspect_ratio_info_present_flag;        /* default value: 0. If 1, aspectratio info belows will be encoded into vui. {0,1} */
    HI_U32 aspect_ratio_idc;                      /* default value: n/a. [0,255],17~254 is reserved. */
	HI_U32 sar_width;                             /* default value: n/a. sar_width  and  sar_height  shall  be  relatively  prime. */
    HI_U32 sar_height ;                  		  /* default value: n/a.  */
}VENC_PARAM_VUI_H265_ASPECT_RATIO_S;
...
{
	VENC_PARAM_VUI_H265_ASPECT_RATIO_S  stVuiAspectRatio;

...
{
    HI_U8 au8SharpenUd[ISO_STENGTH_NUM];    /*Undirectional sharpen strength for undirectional detail enhancement*/
    HI_U8 au8SharpenD[ISO_STENGTH_NUM];     /*Directional sharpen strength for directional detail and edge enhancement*/
	HI_U8 au8TextureThr[ISO_STENGTH_NUM];   /*Sharpen threshold for SharpenUd and SharpenD, noise is deemed as below the TextureThd without sharpness*/
    HI_U8 au8SharpenEdge[ISO_STENGTH_NUM];  /*Sharpen strength for strong edge enhancement*/
    HI_U8 au8EdgeThd[ISO_STENGTH_NUM];      /*Sharpen threshold to distinguish the strong edge, only the edge bigger than the EdgeThd can be sharpen by SharpenEdge*/
    HI_U8 au8OverShoot[ISO_STENGTH_NUM];
    HI_U8 au8UnderShoot[ISO_STENGTH_NUM];
    HI_U8 au8ShootSupStr[ISO_STENGTH_NUM];   /*Overshoot and undershoot suppression strength, the amplitude and width of shoot will be decrease when shootSupSt increase*/
    HI_U8 au8DetailCtrl[ISO_STENGTH_NUM];   /*Different sharpen strength for detail and edge. When it is bigger than 128, detail sharpen strength will be stronger than edge*/

...
{
    HI_S32 s32CSCIdc[VIU_CSC_IDC_NUM];      /* input R G B direct current component offset: [-256~256] */
    HI_S32 s32CSCOdc[VIU_CSC_ODC_NUM];      /* output Y U V direct current component offset: [-256~256] */
